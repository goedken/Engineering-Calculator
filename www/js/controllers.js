    ...
    $scope.assignModal = function(event) {
      ...
      switch(buttonClicked){
        ...
        case ($scope.physics.potEnergy):
          ...
          break;
        case ($scope.general.ftmtr):
          $scope.template.url = 'templates/ftmtr.html';
          break;
        case ($scope.general.mkm):
          $scope.template.url = 'templates/mkm.html';
          break;
        case ($scope.general.mphkph):
          $scope.template.url = 'templates/mphkph.html';
          break;
        case ($scope.general.galL):
          $scope.template.url = 'templates/galL.html';
          break;
        case ($scope.general.whp):
          $scope.template.url = 'templates/whp.html';
          break;
        case ($scope.general.lbN):
          $scope.template.url = 'templates/lbN.html';
          break;
        default:
          break;
      }
